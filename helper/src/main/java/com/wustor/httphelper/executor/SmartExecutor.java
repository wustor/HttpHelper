 ...
 */
package com.wustor.httphelper.executor;
...
public class SmartExecutor implements Executor {
    ...
    private static final int CPU_CORE = ConcurrentUtil.getCoresNumbers();
    ...
    private LinkedList<WrappedRunnable> runningList = new LinkedList<>();
    private LinkedList<WrappedRunnable> waitingList = new LinkedList<>();
